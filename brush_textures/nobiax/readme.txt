All files are sorted into categories. Blacklisted files are listed here. Blacklisting is a measure used to filter out unusable textures (see blacklist.txt).
